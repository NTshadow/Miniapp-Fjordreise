...
**`routeCards.tsx`** – Individuelle rutekort med tidslinje, operatør, varighet og pris. Inkluderer logikk for å vise +1 (dato) når ankomst er dagen etter avreise.
**`utils/formatDuration.ts`** – Hjelpefunksjon for å formatere reisetid og beregne neste-dags-ankomst.
**`summary/page.tsx`** – Oppsummeringsside med generert bookingreferanse.
